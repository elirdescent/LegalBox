      ...
      <div class="modal" role="dialog">
        <div class="modal-box w-11/12 max-w-5xl">
          ...
          <div class="modal-action">
            <label for="my_modal_view_{{$client->id}}" class="btn text-error">Close</label>
          </div>
        </div>
      </div>
   <!-- View Modal -->
        ...
        <!-- Edit Modal -->
          <input type="checkbox" id="my_modal_edit_{{$client->id}}" class="modal-toggle" />
          <div class="modal" role="dialog">
            <div class="modal-box">
              ...
              <div class="mb-6">
                ...
                <div class="flex items-center justify-between ">
                    ...
                    <div class="modal-action">
                      <label for="my_modal_edit_{{$client->id}}" class="btn mb-4 text-error">Close</label>
                    </div>
                </div>
            </form>
            </div>
    ...
    <!-- Delete Modal -->
          <input type="checkbox" id="my_modal_delete_{{$client->id}}" class="modal-toggle" />
          <div class="modal" role="dialog">
            <div class="modal-box">
     ...
     <!-- Delete Modal -->
      ...
      <div class="modal" role="dialog">
        <div class="modal-box">
          ...
          <form action="{{route('clients.store')}}" id="addClientForm" method="POST" class="grid grid-cols-1 gap-4">
            @csrf
            <div class="mb-6">
                <label for="name" class="text-blue-300">Client Name</label>
                <br>
