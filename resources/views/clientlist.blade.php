                ...
                <tr class="text-gray-700 border-b-2 border-cyan-600 border-opacity-25">
                    <td class="px-4 py-3 border-r-1">
                      <div class="flex items-center text-sm">
                        ...
                        <div>
                          <p class="font-semibold text-gray-300">Sufyan</p>
