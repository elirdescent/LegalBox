...
<body>
    <div class="h-screen md:flex ">
        ...
        <div class="flex md:w-1/2 justify-center py-10 px-10 items-center">
            ...
            <form method="POST" class="" id="registerForm" >
                @csrf
                ...
                <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                    ...
                    <input class="pl-2 outline-none border-none bg-base-100 " type="text" name="name" id="name" placeholder="Name" />
          ...
          <div class="flex align-center ml-1 " >
                    ...
                    <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                        ...
                        <input class="pl-2 outline-none border-none bg-base-100" type="text" name="surname" id="surname" placeholder="Surname" />
          </div>
          ...
          <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                        ...
                        <input class="pl-2 outline-none border-none bg-base-100" type="text" name="username" id="username" placeholder="Username" />
          </div>
          ...
          <div class="flex align-center ml-1 " >
                     ...
                     <p class="text-sm font-normal ml-1 mb-2 text-error font-semibold">Only valid emails allowed!</p>
                        ...
                        <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                            ...
                            <input class="pl-2 outline-none border-none bg-base-100" type="email" name="email" id="email" placeholder="Email Address" />
          </div>
          ...
          <div class="flex align-center ml-1 " >
                     ...
                     <p class="text-sm font-normal ml-1 mb-2 text-error font-semibold">Password should contain letters, numbers and symbols!</p>
                            ...
                            <div class="flex items-center border-2 py-2 px-3 rounded-2xl">
                                ...
                                <input class="pl-2 outline-none border-none bg-base-100" type="password" name="password" id="password" placeholder="Password" />
          </div>
